...
public class CsvPublisherHandlerCompressed extends Thread implements MqttCallback {
    ...
    public CsvPublisherHandlerCompressed(MqttClient cl, LineIterator it) throws Exception {
        this.cl = cl;
        this.it = it;
        ...
        try {
            while (true && !Thread.interrupted()) {
                ...
                if (it.hasNext()) {
                    ...
                    FemtoZipCompressionModel femtoZipCompressionModel = dictionaries.get((byte) 3);
                    ...
                    this.cl.publish(Const.CSV_COMPRESSED_TOPIC_NAME, msg, 0, false);
