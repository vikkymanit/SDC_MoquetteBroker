...
public class XmlPublisherHandlerUncompressed extends Thread implements MqttCallback {

    private final MqttClient cl;
    private LineIterator it;

    public XmlPublisherHandlerUncompressed(MqttClient cl, LineIterator it) {
